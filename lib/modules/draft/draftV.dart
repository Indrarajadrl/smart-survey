...
class DraftPage extends StatelessWidget {
  final controller = Get.find<DraftController>(); // injected by Get.create
  @override
          ...
          child: SafeArea(
            child: RefreshIndicator(
                ...
                child: Obx(() => ListView.builder(
                      itemCount: controller.templistdatum.length,
                        ...
                        return Container(
                          child: Column(
                            children: <Widget>[
                              Obx(() => checkPublish(
                                    index,
                                    controller.templistdatum[index],
                                    context,
                                  ))
                            ],
                          ),
  ...
  checkPublish(index, Datum datum, context) {
    if (controller.templistdatum[index].publish != "3") {
      return Container(
        child: Column(
          ...
          children: [
            InkWell(
              onTap: () {
                Get.toNamed(RouteName.detailsurvey, arguments: [datum, true]);
              },
              child: Container(
                height: 200,
